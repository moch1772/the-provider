...
class Post{
    ...
    public function create() {
        $sql = 'INSERT INTO ' . $this->table . ' SET  userID = :userID, title = :title, text = :text, showComments = :showComments, bloggID = :bloggID, hidden = :hidden';
      ...
      public function Update(){
        ...
        $sql = "INSERT INTO blogghistory SET postID='$postID', userID='$userID', showComments='$showComments', text='$text', title='$title', bloggID='$bloggID', hidden='$hidden'";
